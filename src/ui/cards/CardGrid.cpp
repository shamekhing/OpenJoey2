...
int CardGrid::ColCount() { return GRID_COLS; }

void CardGrid::Draw(const std::vector<const openjoey::cards::Card*>& cards, CardImageCache& cache, int x, int y, int w, int h, int cursor, bool focused) {
