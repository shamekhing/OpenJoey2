...
// ── Duel zone tint backgrounds (ZoneCell) — one per zone type
#define COLOR_ZONE_MONSTER_BG      Color{50, 14, 14, 220}
#define COLOR_ZONE_SPELLTRAP_BG    Color{12, 48, 34, 220}
#define COLOR_ZONE_FIELD_BG        Color{12, 30, 58, 220}
#define COLOR_ZONE_EXTRAMONSTER_BG Color{42, 12, 58, 220}
#define COLOR_ZONE_DECK_BG         Color{22, 22, 32, 220}
#define COLOR_ZONE_EXTRADECK_BG    Color{28, 14, 48, 220}
#define COLOR_ZONE_GRAVEYARD_BG    Color{48, 22,  8, 220}
#define COLOR_ZONE_BANISHED_BG     Color{50, 38,  8, 220}
#define COLOR_ZONE_DEFAULT_BG      Color{20, 20, 30, 220}

// ── Duel cursor / selection / card-back accents
#define COLOR_CURSOR_BORDER    Color{255, 220, 0, 255}
#define COLOR_SELECTION_BORDER Color{60, 220, 80, 255}
#define COLOR_ZONE_BORDER_IDLE Color{55, 55, 80, 140}
#define COLOR_CARD_BACK_GOLD   Color{210, 170, 40, 255}
#define COLOR_HAND_BORDER      Color{180, 180, 210, 200}
