...
inline Card cardFromRemoteJson(const nlohmann::json &j) {
    ...
    if (frame == "spell" || frame == "skill") {
        ...
        if (frame != "skill") {
            ...
            if (icon == "Equip")
                add(Attribute::Equip);
            else if (icon == "Continuous")
                add(Attribute::Continuous);
            else if (icon == "Field")
                add(Attribute::Field);
            else if (icon == "Quick-Play" || icon == "QuickPlay")
                add(Attribute::QuickPlay);
            else if (icon == "Ritual")
                add(Attribute::Ritual);
            else
        ...
        if (frame == "fusion")
            add(Attribute::Fusion);
        else if (frame == "ritual")
            add(Attribute::Ritual);
        else if (frame == "synchro")
            add(Attribute::Synchro);
        else if (frame == "xyz")
            add(Attribute::Xyz);
        else
            add(Attribute::Normal);
